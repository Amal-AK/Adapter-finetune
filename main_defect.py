...
def main():
    ...
    parser.add_argument("--train_data_rate_defect", default=0.5, type= float,
    ...
    train_dataset=TextDataset_defect(tokenizer, args, args.train_data_file_defect , nb_samples = args.nb_samples)
    ...
    eval_dataset_defect= TextDataset_defect(tokenizer, args,args.eval_data_file_defect )#, nb_samples=2500  )
    ...
    test_dataset_defect= TextDataset_defect(tokenizer, args,args.test_data_file_defect) #, nb_samples=2500 )
    ...
    if args.do_optimization: 
        ...
        '''
        x =[
            {'insert_modules': ('layer.0.SelfAttention', 'layer.1.DenseReluDense'), 'bottleneck_dim': (32, 32), 'non_linearity': 'relu', 'dropout_rate': 0.0, 'normalization': None, 'skip_connection': True},
            {'insert_modules': ('layer.0.SelfAttention', 'layer.1.DenseReluDense'), 'bottleneck_dim': (32, 32), 'non_linearity': 'relu', 'dropout_rate': 0.0, 'normalization': None, 'skip_connection': True},
            {'insert_modules': ('layer.0.SelfAttention', 'layer.1.DenseReluDense'), 'bottleneck_dim': (32, 32), 'non_linearity': 'relu', 'dropout_rate': 0.0, 'normalization': None, 'skip_connection': True},
            {'insert_modules': ('layer.0.SelfAttention', 'layer.1.DenseReluDense'), 'bottleneck_dim': (32, 32), 'non_linearity': 'relu', 'dropout_rate': 0.0, 'normalization': None, 'skip_connection': True},
            {'insert_modules': ('layer.0.SelfAttention', 'layer.1.DenseReluDense'), 'bottleneck_dim': (32, 32), 'non_linearity': 'relu', 'dropout_rate': 0.0, 'normalization': None, 'skip_connection': True},
        ...
        #model = AdapterModel(model , bottleneck_dim=[256] )
